...
pub const SPATIAL_PRIOR_DEPTH_BINS: usize = 64;
                ...
                for y in min_y..=max_y {
                    for x in min_x..=max_x {
                        ...
                        if power >= -4.5 {
                            ...
                            kernel_sum += (3.0 * nonlinear - 2.0 * optical_depth * gaussian)
                                .max(0.0);
                        }
                    }
                }
                    ...
                    for x in min_x..=max_x {
                        ...
                        if power >= -4.5 {
                            ...
                            let sample_optical_depth =
                                (3.0 * nonlinear - 2.0 * optical_depth * gaussian).max(0.0);
                            ...
                            let front_weight = cell_weight * (-20.0 * relative_depth).exp();
